...
public class ZeroSqure {
    ...
    public ZeroSqure(int n, int m, String[][] board) {
        this.n = n;
        this.m = m;
        this.board = board;
    }
    ...
    public void play() {
        ...
        boolean usestepest= false;
        while (!win()) {
            System.out.println("Enter move (w/a/s/d) to move or (h) to view next step or (dfs) to run DFS or (ucs) to run UCS or (dfsr) to run DFS_RECURSIVE or (astar) to run aStar: ");
            System.out.println("Enter (simpli) to run simpleHillClimbing or (stepest) to run steepestAscentHillClimbing :");
            ...
            if (move.equals("w")) {
                ...
                usedfsR=true;
                break;
            }else if (move.equals("astar")) {
                useastar=true;
                break;
            }else if (move.equals("simple")) {
                usesimple=true;
                break;
            }else if (move.equals("stepest")) {
                usestepest=true;
                break;
            } else {
        ...
        if (usesimple) {
            System.out.println("Running dfs recursion to find solution...");
            aStar astar = new aStar(this);
            astar.simpleHillClimbing();  
        }
        if (usestepest) {
            System.out.println("Running dfs recursion to find solution...");
            aStar astar = new aStar(this);
            astar.steepestAscentHillClimbing();  
        }
    ...
    public ZeroSqure move(int dx, int dy) {
        ...
        return new ZeroSqure(n,m, newBoard);
    }
